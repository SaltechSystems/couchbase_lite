...
class SelectResult {
  ...
  static SelectResultAs property(String _property) => expression(Expression.property(_property));

  static SelectResultAs expression(Expression _expression) => SelectResultAs(_expression,null);
}
...
class SelectResultProtocol {
  ...
  toJson() {
    if (alias != null) {
      return expression.internalExpressionStack + [{"as":alias}];
    } else {
...
class SelectResultAs extends SelectResultProtocol {
  SelectResultAs(Expression expression, String alias) : super(expression, alias: alias);
...
class SelectResultFrom extends SelectResultProtocol {
  SelectResultFrom(Expression expression, String alias) : super(expression, alias: alias);
